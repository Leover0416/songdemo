          ...
          <div className="space-y-6">
            {lyrics?.map((verse, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-white/5 backdrop-blur-md rounded-xl p-6 h-48 overflow-y-auto"
              >
          ...
          <div className="space-y-6">
            {lyrics?.map((verse, index) => (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-md rounded-xl p-6 h-48 overflow-y-auto"
              >
                <p className={`text-lg leading-relaxed font-sans whitespace-pre-line ${index === 2 || index === 5 ? 'text-xl' : ''}`}>
                  {verse?.english}
                </p>
              </motion.div>
            ))}
